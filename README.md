# 💫 About Me:
🚀 Aspiring AI Engineer passionate about transforming ideas into intelligent solutions  <br>🎓 B.Tech CSE (AI & ML) Student at Institute of Aeronautical Engineering  <br>🤖 Enthusiastic about Machine Learning, Deep Learning & AI Innovation  <br>💻 Experienced in Python, TensorFlow, Scikit-Learn & Data Analytics  <br>🛠️ Building impactful AI applications with real-world problem-solving approach  <br>🌱 Constantly learning, improving and exploring next-generation AI technologies


## 🌐 Socials:
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/www.linkedin.com/in/ajaygopagoni) [![email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:ajaygopagoni6@gmail.com) 
...
## 🧠 Ensemble Deep Learning Approach for Emotion Recognition

🔹 Developed a CNN-LSTM model with self-attention for emotion recognition using ECG & EDA signals  
🔹 Applied time-series analysis and feature engineering on the WESAD dataset  
🔹 Improved model accuracy from **77.78% to 98.35%** using transfer learning  
...
🔹 Developed a forward privacy prevention system to secure sensitive cloud data  
🔹 Implemented advanced cryptographic algorithms using Python encryption libraries  
🔹 Improved scalability and reduced vulnerabilities by **25%**  
...
---
[![](https://komarev.com/ghpvc/?username=gopagoniajay&icon=0&color=0)](https://visitcount.itsvg.in)
